...
-(NSData*)readDataWithoutEncryptionAtPath:(NSString*)path error:(NSError**)error;
...
-(NSInteger)writeDataWithoutEncryption:(NSData*)data atPath:(NSString*)path error:(NSError**)error; // DE96741, custom widget files ignore file encryption for both write/read
