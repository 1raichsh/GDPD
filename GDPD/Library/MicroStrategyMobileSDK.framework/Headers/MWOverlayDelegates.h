...
- (void)hilightOverlay:(id<MWOverlayMetaData>)shapeOverlay;
- (void)hilightOverlays:(NSArray<id<MWOverlayMetaData>> *)shapeOverlays;
- (void)dehilightOverlay:(id<MWOverlayMetaData>)shapeOverlay;
- (void)dehighlightOverlays:(NSArray<id<MWOverlayMetaData>>*)shapeOverlays;
- (void)reinit;
