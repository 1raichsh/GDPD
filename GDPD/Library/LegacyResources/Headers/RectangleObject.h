...
namespace MsiChart
{
	...
	protected:
        ...
        /*
            DE125357; Tick Shape Style Support.
            1. GM Tick Shape is as line shape, no fill setting, only line shape setting.
            2. Based on current rectangle render workflow, draw top border of rectangle as tick shape.
            3. Only format line is needed, NO FormatFill.
         */
        bool hIsGMTickShape() const;
        void hDrawGMTick() const;
        void hDrawGMTickHighLight() const;
        void hSetTickPath() const;
        RGBColor hGetTickHighLightColor() const;
    ...
    inline bool RectangleObject::hIsGMTickShape() const
    {
        return mChartContextPtr->IsGraphMatrix() && mChartContextPtr->GetDataset()->GetShapeBySeriesId(mTripleId.mSeriesId) == 8 && mTripleId.mObjectId == DssGraphRiser;   // Tick = 8
    }
}
