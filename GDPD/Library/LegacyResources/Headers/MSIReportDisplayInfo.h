...
// zhaxu; DE114761 disable reprompt button in PDF
@property (nonatomic, assign) BOOL disablePDFReprompt;
/*
 * Serialize
 *
...
/*
 * @return if the first slice definition and data cache exists and are valid.
 */
