...
- (void)handleUnSelectionAllWithLayerIndex:(NSInteger)layerIndex;
- (void)setupZoomScale:(UIView*)iView;
- (BOOL)isViewerInCustomInfoWindow;
- (BOOL)isTargetOnlyOnCustomInfoWindow;
- (BOOL)isEnableClearAllFor:(void*) it;
- (BOOL)isEnableClearAllForRSD:(void*) it;
- (void)handleClearAllForRSD:(void*) it;

- (BOOL)isVIDocument;

@optional

// The following methods maybe from dossier branch or somewhere else. Mark as optional to dismiss related warnings
//- (MapWidgetTypes)mapWidgetType;
- (BOOL)isPlatformWidgetType;
- (void)handleWidgetEvent:(NSString*)event data:(NSObject*)data;
//- (OpenMapModes)openMapMode;
//- (void)openMapAtMode:(OpenMapModes)mode;
- (void)dehilightSelectionInBucket;
- (bool)isUseAsFilter;
- (void)filterNotifySelectionChange:(NSInteger)number;
- (BOOL)isInFilterPanel;
- (NSArray*)getCurrentSelectedRowsInFilterPanel;
- (UIViewController*) getSearchViewController;
