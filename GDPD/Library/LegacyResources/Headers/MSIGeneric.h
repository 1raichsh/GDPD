...
/**
 * Get all the allowed characters set from escape string
 * for replacing deprecated CFURLCreateStringByAddingPercentEscapes with stringByAddingPercentEncodingWithAllowedCharacters 
 * get the characters set for the escape characters
 * @return NSCharacterSet containing all allowed characters
 */
 ...
 * @param statusBarStyle new style of the status bar
 */
 ...
 * Updates style of the status bar.
 * @param statusBarStyle new style of the status bar
 * @param animated whether do animation
 */
+ (void) setStatusBarStyle:(UIStatusBarStyle)statusBarStyle animated:(BOOL)animated;

/**
 * Updates orientation of the status bar.
 * @param interfaceOrientation new orientation of the status bar
 * @param animated whether do animation
 */
 ...
 * @return If an image with input name is found, return the image. Otherwise, return nil.
 */
+ (UIImage* _Null_unspecified) imageWithName:(NSString* _Null_unspecified)name;
 ...
 * @return Whether device is iphoneX
 **/
 ...
 * @return Whether device is iphone XS
 **/
...
+ (void)logCookiesWithClassName:(NSString *)className methodName:(NSString *)methodName;
/**
 * @return safe area padding for iPhoneX.
 */
...
+ (NSString * _Nonnull)getSecureDocumentErrorMessage:(int)errorStatus authenticationMethod:(int)authenticationMode;
