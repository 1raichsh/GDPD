...
/**
 Get MSTR Response Content value from response header
 @method getMSTRResponseContent:
 @param response
 @result  MSTR Response Content value
 */
-(NSString*)getMSTRResponseContent: (NSHTTPURLResponse*)response;

/**
Get HTML String from data with UTF8 encoding or ASCII encoding
@method getHTMLStringFromData:
@param data
@result  HTML String from data
*/
-(NSString *) getHTMLStringFromData:(NSData*)data;
