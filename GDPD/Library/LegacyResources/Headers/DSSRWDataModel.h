...
typedef enum EnumNewFlexBlockType
{
    ...
    EnumNewBlockInitialGBTable        =    5601,
    ...
    EnumNewBlockRAElemetHasChildren = 7102,
    EnumNewBlockRAElemetLeafNode = 7103,

    EnumNewBlockControlModelRAIsDisplay = 7301,
    EnumNewBlockIndividualMetricHide = 7201,
    // calendar
    EnumNewBlockControlModelElementsMask = 7401,
    // only used in library
    EnumNewBlockControlModelRAAllLevels = 7601
...
typedef enum EnumNewRWDBlockType
{
    ...
    EnumBlockFROptimizationFlag = 30008
}EnumNewRWDBlockType;
...
//    @param ipNode : section node.
    ...
    inline bool IsFROptimization() { return mbFROptimization; }
private:
    //hyan,2012/03/21
...
private:
    ...
    bool mbPauseModelUpdating;
    AutoSelectionMap mAutoSelectionMap;
    
    bool mbFROptimization;
};
