...
namespace MsiChart
{
	...
	private:
        ...
        void hAdvanceX(EnumDSSGraphRegressionType iType, double iStartX, double iFactor, double iRealC1, double deltaValueX, double& iorNextStartX, bool& iorUseDefaultValueX);
        void hAddingValues(EnumDSSGraphRegressionType iType, double iMinValueX, double iMaxValueX, double iFactor, double deltaValueX, double iMinStep, double iRealC1, std::vector<double>& iorDataValues);
