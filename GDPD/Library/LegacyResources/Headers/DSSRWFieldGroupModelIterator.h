...
public:	    
    ...
    int getFieldText(int iRow, int iField, MBase::CString &orText, bool *opUseUpdatedData = nullptr);
...
private:
    ...
    int hInitFieldFromFGModel(DSSRWFieldGroupModel* ipModel, vector< vector<Int32> >& ivGroupByElements);
    bool hIsFieldAutoTextClientResolve(DSSField* ipField);
