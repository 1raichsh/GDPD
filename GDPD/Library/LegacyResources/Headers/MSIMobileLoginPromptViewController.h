 ...
 */
- (void) mobileLoginPromptViewController:(nullable MSIMobileLoginPromptViewController *)viewController withPromptType:(MobileLoginPromptType)promptType didDismissWithUpdateFlag:(BOOL) updateFlag;
 ...
 */
- (void) mobileLoginPromptViewController:(nullable MSIMobileLoginPromptViewController *)viewController withPromptType:(MobileLoginPromptType)promptType didEncounterError:(nonnull MSTRError *) error;;
...
@property (nonatomic, weak, nullable) id<MSIMobileLoginPromptViewControllerDelegate> delegate;
@property (nonatomic, strong, nullable) MSIMobileLoginModule* mobileLoginModule;
 ...
 */
- (void) setupWithMobileLoginPromptView:(nullable MSIMobileLoginPromptView *) mobileLoginPromptView mobileLoginModule:(nullable MSIMobileLoginModule*) mobileLoginModule parameters:(nullable NSDictionary*) promptParameters;

/**
 Show the loading view with information.
 @param info The information to displauy
 */
- (void)showLoadingViewWithInfo:(nonnull NSString*)info;
