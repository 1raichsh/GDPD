...
typedef enum EnumDSSGraphType
{
    ...
    DssGraphTypeHorizontal_Waterfall,
    DssGraphTypeVertical_Waterfall,
    DssGraphTypeHorizontal_BoxPlot,
    DssGraphTypeVertical_BoxPlot,
...
typedef enum EnumBinaryContextDetailFlags
{
    ...
    DssBinaryContextDetailBinarySizeOptimization = 0x40000000
...
typedef enum
{
    ...
    DssFunctionWeightCov = 178,
    DssFunctionWeightCorr = 179,
    DssFunctionStrLastPosition = 180,
    DssFunctionStrTitleCap = 181,
    DssFunctionFiscalWeek = 182,
    DssFunctionFiscalMonth = 183,
    DssFunctionFiscalQuarter = 184,
    DssFunctionFiscalYear = 185,
    DssFunctionNullToEmpty = 186,
    DssFunctionDescendants = 187,
    DssFunctionAncetors = 188,
    DssFunctionParents = 189,
    DssFunctionChildren = 190,
