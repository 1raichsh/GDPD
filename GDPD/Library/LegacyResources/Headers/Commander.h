...
@property (nonatomic)CGFloat documentScaleRatioVertical;
...
@property (nonatomic) BOOL goingToUnSelectAll;
/**
...
- (void)setNeedsUpdateOfHomeIndicator;
...
- (CGSize)getCurrentDocumentViewLogicalSizeForScale:(NSInteger)supportedOrientation;
