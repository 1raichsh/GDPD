...
public:
    ...
    virtual HRESULT FindFormWithLocale(int iAttribute, int iBaseFormID, int iLocale, int *opColumn);
    virtual HRESULT FindFormWithLocale(int iAttribute, int iBaseFormID, int iLocale, int &orColumn);
