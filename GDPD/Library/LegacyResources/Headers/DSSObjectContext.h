...
private:
    ...
    */
    ...
    //DE90558, 4/9/2018, resolve {USER} autotext in cache file.
...
//	std::string getDefaultFormatPropertyValue(std::string iPropertySetName, std::string iPropertyName);
    ...
    bool getExtendedShowHideNull();
};

inline void DSSObjectContext::setUserName(std::string iUserName)
{
    mUserName = iUserName;
}

inline std::string DSSObjectContext::getUserName()
{
    return mUserName;
}
