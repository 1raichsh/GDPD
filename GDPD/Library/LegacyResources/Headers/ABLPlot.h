...
namespace MsiChart
{
	...
	public:
		...
		*/
		double GetGroupTotals(Int32 iGroupId, EnumValueAxis iValueAxis = VA_Y1) const;
	...
	private:
		...
		*/	
        ...
        std::vector<std::vector<double> > mGMGroupTotals;   // US166097; Graph Matrix Dual axis support
	...
	inline double ABLPlot::GetGroupTotals(Int32 iGroupId, EnumValueAxis iValueAxis) const
	{
        if (mChartContextPtr->IsGraphMatrix()) {
            return mGMGroupTotals[iValueAxis][iGroupId];
        }
