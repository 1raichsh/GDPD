...
#define MAP_ATTRIBUTE_START_FORM_GLOBAL_INDEX @"mapAttributeStartFormGlobalIndex"
#define MAP_ATTRIBUTE_FORM_COUNT @"mapAttributeFormCount"
#define MAP_ATTRIBUTE_DISPLAY_FORM_LOCAL_INDICES @"mapAttributeDisplayFormLocalIndices"
#define MAP_ATTRIBUTE_TOOLTIP_FORM_LOCAL_INDICES @"mapAttributeTooltipFormsLocalIndices"
