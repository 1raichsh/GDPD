...
{
public:
    virtual HRESULT Calculate (int nSize, CComVariant* pVec, EnumDSSDataType iType, CComVariant* pResult,
                           DSSDataFlag * pFlag );
    
    virtual HRESULT getOutputType (EnumDSSDataType InputType, EnumDSSDataType * OutputType );
};
