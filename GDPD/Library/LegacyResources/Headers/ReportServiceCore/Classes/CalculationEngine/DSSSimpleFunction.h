...
public:
	...
	virtual HRESULT Calculate(int nParam, double *ipParams, double *opResult, DSSDataFlag *opFlag) = 0;
	
	HRESULT CalculateRepeat(int nParam, int nRepeat, double **ipParams, double *opResult, DSSDataFlag *opFlag);
