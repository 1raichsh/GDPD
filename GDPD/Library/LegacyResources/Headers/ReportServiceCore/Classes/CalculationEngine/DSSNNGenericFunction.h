...
public:
    ...
    virtual HRESULT GetOutput(Int32, Int32 *, CComVariant *, DSSDataFlag *) = 0;    
    
    virtual HRESULT GetOutputType(Int32, EnumDSSDataType *, EnumDSSDataType *, EnumDSSParameterType *) = 0;
    
    virtual HRESULT SetInputParam(Int32, Int32, EnumDSSDataType,CComVariant *, DSSDataFlag *) = 0;
