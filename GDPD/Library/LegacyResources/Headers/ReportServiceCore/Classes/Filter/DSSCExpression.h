...
public:
    ...
    // weilin Used for calendar selector, the date node can be DSSExpNodeConstant.
    DSSExpNodeConstant* getConstantChild(int iIndex);
    // weilin DE108400 8/15/18 Used for calendar selector, the date node can be DSSExpNodeTime.
    DSSExpNodeTime* getDateChild(int iIndex);
