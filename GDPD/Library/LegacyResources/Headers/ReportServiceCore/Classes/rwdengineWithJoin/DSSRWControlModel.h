...
public:
    ...
    // weilin US126676 8/1/18 check selection in mpSelectorElementMask
    bool isValidSelection(unsigned Int32 absolutePos);
    bool calendarOptimization();
private:
    //junwang, 2012/02/17
    ...
    //zhyang, 804162
    //int mPrimaryFlag;
    // weilin US126676 7/31/18 Selector element bit vector
    DSSXTabBitVector *mpSelectorElementMask;
};
