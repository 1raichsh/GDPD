...
public:
    ...
    int generateDefaultSortDefinitionRespectHierarchy(DSSAxis* axis, vector<int>& unitIDs, vector<DSSSortDefinition*>* definitions, vector<DSSSortDefinition*>& userDefinedDefinitions, vector<int>& mask);
...
private:
    ...
    int unitID2TemplateIndex(DSSAxis* ipAxis, int iUnitId);
    ...
    // weilin DE42405 2017/1/16 mark the stack by total tag here
    int mStackTotalTag;
};
