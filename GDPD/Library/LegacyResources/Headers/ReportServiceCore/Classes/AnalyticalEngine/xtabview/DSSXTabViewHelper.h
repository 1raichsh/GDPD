...
public:
	...
	static int InitXTabView(DSSViewDataSet *ipViewDataSet, 
                            ...
                            bool iDoPreXTab = true, DSSMaskInfos *ipMaskInfo = NULL, bool ibHideZero = false, bool ibHideNull = false, MCESchema* ipSchema = NULL, vector<vector<DSSMaskInfos*> >* ipMetricHideMaskInfo = NULL);//fali, 815802, add parameter to support NullOrZero
