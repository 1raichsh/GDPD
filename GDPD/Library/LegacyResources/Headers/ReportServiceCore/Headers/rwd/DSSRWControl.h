...
private:
    ...
    int mActualWriteBackFormID; //please refer GridTransactionDelegate.ConvertGridCell
    ...
    // linking flag
    bool mIsNavigation;
    std::string mTargetPageKey;
    
    // weilin DE130747 4/3/19 for calendar selector
    bool mbGetCalendarSelectorFromServer;
    // mbIsCalendarSelector/mCalendarFormID/mCalendarBaseFormID make sense if mbGetCalendarSelectorFromServer = true
    bool mbIsCalendarSelector;
    GUID mCalendarFormID;
    int mCalendarBaseFormID;
...
public:
    ...
    const std::string& getTargetPageKey() { return mTargetPageKey;};
    ...
    inline int getActualWriteBackFormID() {return mActualWriteBackFormID; };
    inline void setActualWriteBackFormID(int iFormID) { mActualWriteBackFormID = iFormID; };
    bool isValid();
    // weilin DE130747
    bool isCalendarSelectorFromServer() {
        return mbGetCalendarSelectorFromServer;
    }
    bool isCalendarSelector() {
        return mbIsCalendarSelector;
    }
    int getCalendarBaseFormID() {
        return mCalendarBaseFormID;
    }
    GUID getCalendarFormID();
private:
