...
typedef enum EnumBinaryDefnBlockType
{
    ...
    // weilin 2017/3/21 US74106
    BINARY_BLOCK_DISPLAY_TEXT = 125,
    ...
    BINARY_BLOCK_TEMPLATEELEM_DRAW_VISUALIZATION = 1221,
    BINARY_BLOCK_TEMPLATEELEM_MODELS = 1222,
	...
	BINARY_BLOCK_CONTROL_LEVEL = 1237,
    ...
    BINARY_BLOCK_TEMPLATE_LIMIT = 1242,
    // msun, for linking feature
    BINARY_BLOCK_NAVIGATION_INFO = 1243,
    BINARY_BLOCK_CONSOLIDATION_ATTRIBUTE_ID = 1244,

    // zsun, block to support map offline
    BINARY_BLOCK_DOCUMENT_WIDGET_2 = 1245,
    
    BINARY_BLOCK_DOCUMENT_PROPERTIES_MAP = 1246,
    
    // weilin, 7/10/17 US92477 drill view filter
    BINARY_BLOCK_NODE_PROPERTIES = 1247,
    
    // vpena, support for dynamic dates
    BINARY_BLOCK_NODE_DYNAMIC_TIME = 1248,

    // zsun, 1249 for image layout precache, contains image layout urls for shpaefiles
    BINARY_BLOCK_IMAGELAYOUT = 1249,
    
    //2018-07-23, US121623, feliang, control sorting info
    BINARY_BLOCK_CONTROL_SORTING = 1251,
    
    // weilin 4/3/19 DE130747 for calendar selector
    BINARY_BLOCK_CONTROL_CALENDAR_SELECTOR = 1252
...
typedef enum EnumManipulationCommandTypes
{
    ...
    ManipulationCreateUnitSubtotals = 206,
    ManipulationExpandRecursiveAttribute = 207,
    ManipulationShowSubtotals = 208,
    ManipulationChangeConditionOnNode = 209,
    ManipulationSetTemplateLimit = 210,

    // weilin US79472 2017/2/17
    ManipulationSortGM = 211,
    
    // weilin DE59842 2017/4/27
    ManipulationViewFilterSummary = 212,
...
typedef enum EnumDSSRuntimeSubtotalType
{
    ...
    DssRuntimeSubtotalStackTotal = 0x00080,
