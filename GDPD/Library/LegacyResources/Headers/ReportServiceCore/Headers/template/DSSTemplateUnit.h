...
public:
    ...
    inline std::vector<int>& getSubtotalTypes() {return mSubtotalTypes;}
    inline void setSubtotalTypes(std::vector<int> iSubtotalTypes) { mSubtotalTypes = iSubtotalTypes; }
};
