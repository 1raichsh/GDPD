...
protected:
    ...
    //DE75722 save definition nodekey
    std::set < std::string > mDefinitionNodeKeyCollection;
...
public:
    ...
    // weilin DE59842 2017/4/28
    bool IsMacro() { return mIsMacro; }
	
    //DE75722
    std::string getdefinitionNodeKey();
};
