...
public:
    ...
    static int updateSourceTemplateConsideringNDE(DSSRWNode* iSrcNode, vector<DSSRWNode*> &ivNodes, bool ibUpdateGlobalheader);
private:
    ...
    static bool isDDA(DSSTemplate* ipTemplate);
};
