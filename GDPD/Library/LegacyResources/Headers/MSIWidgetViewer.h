...
@interface MSIWidgetViewer : UIView <IWidgetProtocol, ItemRendererDelegate, WidgetGridSwitchProtocol,  VisualizationViewerProtocol, TemporaryCanvasViewForLassoSelectionDelegate, LassoSelectionOperationDelegate, WidgetPropManipulationProtocal, BinaryRetrievalHandler> {
