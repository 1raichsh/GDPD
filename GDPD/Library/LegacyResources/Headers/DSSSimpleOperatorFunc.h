...
public:
	...
	virtual HRESULT Calculate(int nParam, double *ipParams, double *opResult, DSSDataFlag *opFlag);
    
    virtual HRESULT Calculate(int nParam, CComVariant *ipParam, CComVariant *opResult, DSSDataFlag *opFlag);
    
    virtual HRESULT GetOutputType (int size, EnumDSSDataType *inputType, EnumDSSDataType *outputType);
    ...
    virtual HRESULT CalculateCellData(Int32 nParam, CComVariant * pParam, CComVariant * pResult, DSSDataFlag * pFlag);
