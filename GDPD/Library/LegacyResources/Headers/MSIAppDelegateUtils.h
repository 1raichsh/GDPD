...
@interface MSTRCustomNavigationController : UINavigationController

@end

@interface UIViewController(GD)

- (UIViewController *)topViewControllerForGDRotate;

- (BOOL)isGDController:(NSString *)controllerName;
