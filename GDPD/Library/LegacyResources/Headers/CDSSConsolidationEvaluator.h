...
public:
    ...
    virtual HRESULT Calculate(int nParam, double *pParam, double *pResult, DSSDataFlag *pFlag);
    ...
    virtual HRESULT Calculate(int nSize, CComVariant *pVec, CComVariant *opResult, DSSDataFlag *pFlag);
