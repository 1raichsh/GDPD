...
//DE99555, msun, This property is to retain self so that self won't be dismissed after alertController is presented. We should set it only when it needs button actions. And don't forget to reset it to nil after alertController is dismissed.
@property(nonatomic) id _Nullable retainSelf;
