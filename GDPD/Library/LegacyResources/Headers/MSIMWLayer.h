 ...
 */
@property (nonatomic, readonly) SafeMutableDictionary* annotationData;
@property (nonatomic, retain) SafeMutableArray* annotationBlockInfo;
...
@property (nonatomic, strong) NSMutableSet* usedThresholdIDSet;
...
- (void)drawAffinityLayerOnMainThread:(NSNumber*)sequence;
