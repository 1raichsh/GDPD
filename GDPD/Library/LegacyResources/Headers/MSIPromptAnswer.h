...
typedef enum _AnswerModes{
	EnumAnswerModeSamePrompt = 1, EnumAnswerModeDoNotAnswer, EnumAnswerModeClose, EnumAnswerModeDynamic, EnumAnswerModeStatic, EnumAnswerModeCurrentUnit, EnumAnswerModeAllValidUnits, EnumAnswerModeDefaultAnswer, EnumAnswerModeDynamicOrSamePrompt
} AnswerModes;
