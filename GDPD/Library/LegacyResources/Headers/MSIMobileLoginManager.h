 ...
 */
- (void)handleMobileLoginPromptDisplay:(MobileLoginPromptType)promptType __attribute__((deprecated("use handleMobileLoginPromptDisplay:promptType:promptParameters instead.")));

/**
 Called after the prompt is dismissed and the login of mobile login prompts is success.
 @param promptType The type of the prompt.
 */
- (void)handleMobileLoginPromptSuccess:(MobileLoginPromptType)promptType __attribute__((deprecated("use handleMobileLoginPromptSuccess:promptType:promptParameters instead.")));

/**
 Called after the prompt is dismissed and the login of mobile login prompts is canceled.
 @param promptType The type of the prompt.
 */
- (void)handleMobileLoginPromptCancel:(MobileLoginPromptType)promptType __attribute__((deprecated("use handleMobileLoginPromptCancel:promptType:promptParameters instead.")));
...
/**
 ...
 @param promptType The type of the prompt.
 */
- (void)handleMobileLoginPromptError:(nonnull MSTRError*)error
                          promptType:(MobileLoginPromptType)promptType __attribute__((deprecated("use handleMobileLoginPromptError:error:promptType:promptParameters instead.")));

/**
 Called before mobile login prompts displays.
 @param promptType The type of the prompt.
 @param promptParameters Parmaters for creating the prompt.
 */
- (void)handleMobileLoginPromptDisplay:(MobileLoginPromptType)promptType promptParameters:(nullable NSDictionary *)promptParameters;

/**
 Called after the prompt is dismissed and the login of mobile login prompts is success.
 @param promptType The type of the prompt.
 @param loginPromptParameters Parmaters for creating the prompt.
 */
- (void)handleMobileLoginPromptSuccess:(MobileLoginPromptType)promptType promptParameters:(nullable NSDictionary *)promptParameters;
...
/**
 ...
 @param loginPromptParameters Parmaters for creating the prompt.
 */
- (void)handleMobileLoginPromptCancel:(MobileLoginPromptType)promptType promptParameters:(nullable NSDictionary *)promptParameters;
 ...
 */
- (void)handleMobileLoginPromptError:(nonnull MSTRError*)error
                          promptType:(MobileLoginPromptType)promptType
                    promptParameters:(nullable NSDictionary *)promptParameters;
 ...
 */
+ (nonnull MSIMobileLoginManager*) sharedMobileLoginManager;
 ...
 */
- (int)showPrompt:(MobileLoginPromptType)promptType parameters:(nullable NSDictionary *)promptParameters delegate:(nullable id<MSIMobileLoginPromptDelegate>)delegate animated:(BOOL) animated;

- (int)showPrompt:(MobileLoginPromptType)_promptType parameters:(nullable NSDictionary *)_promptParameters delegate:(nullable id<MSIMobileLoginPromptDelegate>)_delegate;
 ...
 */
- (void)unRegisterPromptDelegate:(nonnull id<MSIMobileLoginPromptDelegate>)delegate;
...
- (nullable MSIConnectionManager *)getConnectionManager;
 ...
 * @param promptType the prompt type
 */
- (void)setView:(nullable MSIMobileLoginPromptView *) userDefinedPromptView controller:(nullable MSIMobileLoginPromptViewController *) userDefinedPromptViewController module:(nullable MSIMobileLoginModule *)userDefinedPromptModule forPromptType:(MobileLoginPromptType)promptType;
 ...
 */
@property (nonatomic, retain, nullable) MSIConnectionManager* connectionManager;

/**
 * The user defined connection manager
 */
@property (nonatomic, retain, nullable) MSIConnectionManager* userDefinedConnectionManager;

- (int)showCredentialsPromptWithParameters:(nullable NSDictionary *)_promptParameters delegate:(nullable id<MSIMobileLoginPromptDelegate>)_delegate;
