...
namespace MsiChart{
    ...
    public:
        ...
        Int32 GetSeriesCountForShape(Int32 iShapeType);
        ...
        bool getGenericLineColor(unsigned int& orLineColor, bool& orUseDefaultColor, Int32 iSeriesId ,Int32 iGroupId,Int32 iAngleId = -3 , Int32 iSliceId = -3);
