...
- (CGFloat)navigationTabBarHeight;
...
// Mobile Export
- (BOOL)isExporting;
- (void)handleWillQuitExport:(void (^)(void))handler;
...
// scale fit to safeArea/full screen
- (BOOL)isFitToFullScreen;
- (void)setFitToFullScreen:(BOOL)fullScreen;
