...
namespace MsiChart{
    ...
    public:
        ...
        virtual bool GetTrendlineCastCount(int& iorBackCastCount, int& iorForecastCount);
        ...
        virtual Int32 GetSeriesCountForShape(Int32 iShapeType);
        ...
        virtual bool getGenericLineColor(unsigned int& orLineColor, bool& orUseDefaultColor,Int32 iSeriesId ,Int32 iGroupId,Int32 iAngleId = -3 , Int32 iSliceId = -3);
        virtual bool HasAxisOrigin(Int32 iMetricIndex);
