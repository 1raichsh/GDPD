...
namespace MsiChart
{
	...
	public:
        ...
        virtual bool GetGenericLineColor(RGBColor& orLineColor, bool& orUseDefaultColor,Int32 iSeriesId ,Int32 iGroupId,Int32 iAngleId = -3 , Int32 iSliceId = -3) = 0;
        ...
        virtual bool HasAxisOrigin(Int32 iMetricIndex) = 0;
#ifndef _VE_CE
        //============================================================================
		//AE Integration
        /**
...
public:		
        ...
        virtual Int32 GetSeriesCountForShape(Int32 iShapeType) = 0;
        ...
        // RSD Graph Value Axis data type check
        ...
        // DE119988, DE120668, should not filter forecast and backcast trendline points.
        virtual bool GetTrendlineCastCount(int& iorBackCastCount, int& iorForecastCount) = 0;
	};
