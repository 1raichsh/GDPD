...
#define CALENDAR_TIME_BUTTON_HEIGHT 44
#define CALENDAR_TIME_BUTTON_GAP 15

#define CALENDAR_HEIGHT_IPHONE_RATE (6.0 / 7.0)
#define CALENDAR_HEIGHT_IPHONE_ADDITION (57 - 12 * CALENDAR_HEIGHT_IPHONE_RATE)
