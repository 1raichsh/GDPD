...
@property (nonatomic) BOOL fitToFullScreen; //US133842 NavigationBar is out of dataController, use this var to decide fit mode
...
/**
 * @return YES if MSTRNavigationBarController needs to update status bar style
 * Before getting statusBarStyle from MSTRNavigationBarController, check whether this property is YES.
 */
@property (nonatomic, readonly) BOOL needUpdateStatusBarStyle;

/**
 * @return preferredStatusBaryStyle for view controllers
 */
@property (nonatomic, readonly) UIStatusBarStyle statusBarStyle;

- (void)setHidesRightBarButtonItems:(BOOL)hidesRightBarButtonItems;

- (void)setNavigationItemRightBarButtonItemsEnabled:(BOOL) enabled;
