...
@property (nonatomic, readonly) NSSet* unreconciledProjects;
...
@property(nonatomic, strong) NSMutableArray* subscriptionNotificationArray;
...
- (UIView*)displayNewFloatingViewOnView:(UIView*)view withText:(NSString*)text viewHastoobar:(BOOL)viewHastoobar hasActivityIndicator:(BOOL)hasActivityIndicator position:(NSInteger)pos;
...
- (void)handleHttp:(NSURL*)url inApp:(BOOL)inApp;
