...
public:
    ...
    virtual HRESULT FindFormWithLocale(int iAttribute, int iBaseFormID, int iLocale, int *opColumn) {return 0;}
    virtual HRESULT FindFormWithLocale(int iAttribute, int iBaseFormID, int iLocale, int &orColumn) {return 0;}
};
...
// copy from Data Service Layer
enum DataImportSpecialDateType
{
    DB_NOT_DATE_TYPE = 0,
    DB_DAY_OF_WEEK,
    DB_DAY_OF_WEEK_LONG,
    DB_MONTH_OF_YEAR,
    DB_MONTH_OF_YEAR_LONG,
    // May is special because it appeared in both gMonthOfYearArray and gMonthOfYearLongArray
    DB_MONTH_OF_YEAR_MAY
};

static const wchar_t* gDayOfWeekArray[] = {L"Sun", L"Mon", L"Tue", L"Wed", L"Thu", L"Fri", L"Sat"};
static const Int32 gDayOfWeekArraySize = sizeof(gDayOfWeekArray) / sizeof(gDayOfWeekArray[0]);

static const wchar_t* gDayOfWeekLongArray[] = {L"Sunday", L"Monday", L"Tuesday", L"Wednesday", L"Thursday", L"Friday", L"Saturday"};
static const Int32 gDayOfWeekLongArraySize = sizeof(gDayOfWeekLongArray) / sizeof(gDayOfWeekLongArray[0]);

static const wchar_t* gMonthOfYearArray[] = {L"Jan", L"Feb", L"Mar", L"Apr", L"May", L"Jun", L"Jul", L"Aug", L"Sep",
    L"Oct", L"Nov", L"Dec"};
static const Int32 gMonthOfYearArraySize = sizeof(gMonthOfYearArray) / sizeof(gMonthOfYearArray[0]);

static const wchar_t* gMonthOfYearLongArray[] = {L"January", L"February", L"March", L"April", L"May", L"June", L"July", L"August",
    L"September", L"October", L"November", L"December"};
static const Int32 gMonthOfYearLongArraySize = sizeof(gMonthOfYearLongArray) / sizeof(gMonthOfYearLongArray[0]);
...
public:
	...
	static int CompareStringsWithLocale(const char * string1, const char * string2, int size1, int size2, int locale, bool ibSimpleComparison = true, bool ibCaseSensitive = true);
...
//                      DSSViewDataSet *ipViewDataSet,
    ...
    static int GetRawDataForTabularUnit(DSSGUnitContainer *ipUnitContainer, DSSObjectInfo* ipObjInfo, GUID& iUnitGUID, int iGlobalKey, int &oDataType, const void **oppData, DSSTabularAttribute *ipTabularAttribute = NULL);
    ...
    // 2017/4/25 The 7 functions(UTF8ToGBK ~ compareWithSpecialChar) below are now deprecated. Now we have a more powerful CompareStringsWithLocale.
    ...
    // DE98970, copy from jxie 2013-12-27, TQMS 818707
    static DataImportSpecialDateType STDMETHODCALLTYPE DetectSpecialDateType(const wchar_t* ipValue, DataImportSpecialDateType iCurrentType, Int32& orIndex);
    
    inline static Int32 WCharStrCaseCmp(const wchar_t* ipWstr1, const wchar_t* ipWstr2)
    {
#ifdef WIN32
        return ::wcsicmp(ipWstr1, ipWstr2);
#elif defined(linux)
        return ::wcscasecmp(ipWstr1, ipWstr2);
#else
        return ::strcasecmp(MBase::WideCharToUTF8(ipWstr1).c_str(), MBase::WideCharToUTF8(ipWstr2).c_str());
#endif
    }
...
private:
    ...
    static string getLocaleLanguage(int iLocale)
    {
        static map<int, string>lLocaleLanguageMap;
        if (lLocaleLanguageMap.size() == 0)
        {
            std::string lLocaleLanguageCodeSet [] = {
                "en_US", "da_DK", "de", "en", "es",
                "fr", "it", "ja", "ko",
                "pt", "sv", "zh", "zh_TW",
                //newly added:
                "cs", "he", "hu", "sk", "sl", "hr",
            ...
            int lLocaleIdSet [] = {
                0, 1030, 1031, 1033, 3082, 1036, 1040, 1041, 1042, 1046, 1053, 2052, 1028,
                //newly added:
                1029, 1037, 1038, 1051, 1060, 1050,
                //added again
                1078, 1052, 1067, 1069, 1059,
                1026, 1027, 1050, 1030, 1061, //10
                1080, 1065, 1035, 1084, 1032,
                1037, 1081, 1038, 1039, 1057, //20
                1062, 1063, 1071, 1082, 1102,
                2068, 1045, 1047, 1049, 1103, //30
                1070, 1089, 1097, 1054, 1055,
                1092, 1058, 1056, 1066, 1043,  //40
                2055, 2060, 2064, 4108, 1034
            };
            int lSize = sizeof(lLocaleIdSet) /sizeof(int);
            for (int i = 0; i < lSize; i++)
            {
                lLocaleLanguageMap[lLocaleIdSet[i]] = lLocaleLanguageCodeSet[i];
            }
        }
        return lLocaleLanguageMap[iLocale];
    }
};
