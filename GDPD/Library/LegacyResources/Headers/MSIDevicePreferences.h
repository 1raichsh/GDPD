...
#define ID_DOCUMENT_RUNTIME_MEMORY_LIMIT @"drml" //Memory limit of document runtime (in MB)
...
#define ID_REQUIRED_PROMPTS_FIRST @"PromptsRequiredFirst"
...
/**
 * Readonly property indicates whether the device preference contains default value.
 * isDefaultPreference by default is NO when it's loaded from preferences file or created manually.
 * Copied DevicePreference will carry over the isDefaultPreference of original DevicePreference.
 * DevicePreference with isDefaultPreference=YES can't be saved
 * To get a DevicePreference with isDefaultPreference=YES, use method getDefaultDevicePreferences
 */
@property (readonly) BOOL isDefaultPreference;
...
/*
 use this method to identify whether we should display the required prompt questions first.
 */
- (BooleanPreference *) getPromptsRequiredFirst: (MSIProjectInfo*)project;

/*
 use this method to add preference
 */
-(void)setPreference:(id)preference forKey:(NSString*)fKey;

/*
 Use this method to create MSIDevicePreferences with all default values. And the isDefaultPreference property will be YES in the returned instance.
 */
