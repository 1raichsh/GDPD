...
//DE139819; should adjust band max value for map. It should not be row count.
- (ThresholdSliderData*) getThresholdInfoForMap:(NSString*)iMetricID defaultIndex:(int)index threshold:(BOOL*)oHasThresholdInfo withIgnoreTotal:(BOOL)ignoreTotal;
 ...
 */
- (void*) getDropZoneSet;
- (void*) getGridIterator;
- (NSString*) getMetricFormatStringForColumn:(int) iCol;
- (NSString*) getAttributeElementID:(AxisType)type withOrdinal:(NSInteger)rowIndex withDepth:(NSInteger)titleIndex;
