...
@property (nonatomic) CGFloat scaleRatioVertical;
@property (nonatomic) BOOL enabled;
// some elements should apply scale on iPad but not on iPhone, these var used to separate scaleRatio
@property (nonatomic, readonly) CGFloat ratioH;
@property (nonatomic, readonly) CGFloat ratioV;
#pragma mark -
...
//DE104270 support string metric for metric menu selector
+(BOOL)isMetricSupportedMax:(const CComVariant*)_max andMin:(const CComVariant*)min andCount:(const CComVariant*)count withStyle:(EnumSelectorStyle)style;
@end
