...
/**
 * get view's rect in it's superest view coordinate
   different from [convertRect toView], this method won't affected by scrolling
 
 * @param   view    The view needs to calculate frame in super coordinate
 */
+(CGRect)getBaseCoordinateRect:(UIView*)view;
