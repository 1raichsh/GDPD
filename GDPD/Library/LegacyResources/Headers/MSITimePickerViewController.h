...
@class MSITimePickerActionController;

@interface MSITimePickerViewController : UIViewController <UIPopoverControllerDelegate, TimeViewController> {
	CGRect mPickerFrame;
	CGRect mRootFrame;
    ...
    MSITimePickerActionController *pickerActionSheetController;
}
