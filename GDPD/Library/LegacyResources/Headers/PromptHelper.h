...
@interface PromptHelper : NSObject <ServiceHandler, CalendarDelegate, CLLocationManagerDelegate, MKMapViewDelegate, BarcodeScannerControllerDelegate, KeypadInputControllerDelegate> {
