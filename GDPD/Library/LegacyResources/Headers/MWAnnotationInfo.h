...
-(id)initWithIterator:(void *)iter formatManager:(void *)formatManager rowOffset:(NSInteger)_rowOffset colOffset:(NSInteger)_colOffset formatManagerLock: formatManagerLock;
