...
- (BOOL) isTitleSelectableWith:(DSSRWGridIterator*)it iAxis:(int)iAxis withDepth:(int)iDepth;
...
- (Command*) getCommandForEntireRow: (int)iAxis withOrdinal:(int)iOrdinal;
...
-(BOOL)supportNavigation;
-(BOOL)supportNavigationFor:(DSSRWGridIterator*)iterator;
